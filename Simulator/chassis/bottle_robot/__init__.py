...
class BottleRobot(chassis.Chassis):
    def __init__(self):
        ...
        self.outputs.append(pio.Output('left_wheel', set_left_wheel_speed))
        self.outputs.append(pio.Output('right_wheel', set_right_wheel_speed))
        self.inputs.append(pio.Input('left_wheel', get_left_wheel_rotation))
        self.inputs.append(pio.Input('right_wheel', get_right_wheel_rotation))
